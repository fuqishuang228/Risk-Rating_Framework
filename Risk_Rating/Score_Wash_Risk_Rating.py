...
Transaction_Info = pd.read_csv('./data/Transaction_Information0331.csv')
...
Tx_Score = Transaction_Info["score_wash0331"]
...
fw = open("./results/20220331-Score-Wash-Account-trust-reliabl-risk-unsupervised-riskprop.csv", "w")
...
fw_confidence = open("./results/20220331-Score-Wash-Transaction-score-confidence-riskprop.csv", "w")
