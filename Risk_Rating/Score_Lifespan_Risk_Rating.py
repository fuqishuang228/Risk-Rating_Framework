...
Transaction_Info = pd.read_csv('./data/Transaction_Information0319.csv')
...
Tx_Score = Transaction_Info["score_life_span"]
...
fw = open("./results/20220319-Score-Life-span-Account-trust-reliabl-risk-unsupervised-riskprop.csv", "w")
...
fw_confidence = open("./results/20220319-Score-Life-span-Transaction-score-confidence-riskprop.csv", "w")
